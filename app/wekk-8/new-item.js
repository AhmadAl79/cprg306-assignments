...
export default function NewItem({ onAddItem }) {
  ...
  function handleSubmit(e) {
    ...
    const newItem = { ...item, id: generateId(), name: item.name.trim() };
    onAddItem(newItem);
      ...
      <div className="flex mx-auto w-fit h-full rounded-md">
        ...
        >
          ...
          <button
            ...
            className="border w-1/2 mx-auto rounded-sm text-xl hover:bg-cyan-600 hover:text-white disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Add Item
          </button>
        </form>
